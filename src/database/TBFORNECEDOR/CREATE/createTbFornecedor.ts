...
const createTbFornecedor = (db: SQLiteDatabase) => {
  const query = `CREATE TABLE IF NOT EXISTS TBFORNECEDOR (
    DFIDFORNECEDOR INTEGER PRIMARY KEY AUTOINCREMENT,
